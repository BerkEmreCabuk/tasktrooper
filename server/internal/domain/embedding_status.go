...
// provider catalog, which a named llm_endpoints row is deliberately absent
// from — so a workspace embedding happily on its own endpoint was told no
// provider could produce embeddings at all. The catalog cannot answer this
// question; this can.
