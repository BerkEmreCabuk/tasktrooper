...
// The six role agents are created automatically by the backend's catalog sync
// at boot — there is no "set up the ready-made team" from templates any more.
// This dialog only offers a blank agent and the templates the operator saved.
          ...
          <div className="space-y-2">
            {templates.map((tpl) => (
              <Card key={tpl.id} className="flex items-center justify-between gap-3 p-3">
                ...
                <Button size="sm" disabled={creatingFromId !== null} onClick={() => createFromTemplate(tpl)}>
