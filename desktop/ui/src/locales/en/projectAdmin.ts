...
export const projectAdmin = {
  projectSettings: {
    ...
    typeTitle: "Type & release",
    typeDesc: "What this repository is, and whether a task reaching Done releases it by itself.",
    tabs: {
      general: "General",
      code: "Code & docs",
      pipeline: "Pipeline",
    ...
    reposDesc: "Every sub-repo's docs and pipeline, together under its own tab. Its addresses live under Deploy, where the scope picker names it.",
    rootTab: "Root",
  ...
  hosting: {
    ...
    subtitle: "Where this scope ships to, and what it is doing there right now.",
    scope: "Scope",
    ...
    gcloud: {
      ...
      notBoundDesc:
        "Bind the Cloud Run service or GKE cluster this scope ships to, and its state, revisions and traffic show up here.",
      bindResource: "Bind a resource",
      changeResource: "Change resource",
      unbind: "Unbind",
      unbindTitle: "Unbind this Google Cloud resource?",
      unbindDescription:
        "{name} is left untouched in Google Cloud. TaskTrooper only stops reading it for this scope.",
      unbound: "Google Cloud resource unbound",
      loadFailed: "Could not load the Google Cloud resource",
      resource: "Resource",
      kind: "Type",
      project: "Project",
      location: "Location",
      cloudRunTitle: "Cloud Run service",
      ...
      gkeTitle: "GKE cluster",
      masterVersion: "Control plane version",
      nodeCount: "Nodes",
      autopilot: "Autopilot",
      privateEndpoint: "Private endpoint",
      nodePools: "Node pools",
      detailUnavailableTitle: "The binding is saved; the live read is not available",
      detailNotConnected:
        "No Google Cloud service account is saved, so the resource cannot be read. The binding itself is kept.",
      detailUnsupported:
        "The saved service account is not allowed to read this resource. The binding itself is kept.",
    },
  },
