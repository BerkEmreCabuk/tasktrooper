...
export const projectAdmin: ProjectAdminDict = {
  projectSettings: {
    ...
    typeTitle: "Tür ve release",
    typeDesc: "Bu deponun ne olduğu ve Done'a gelen bir görevin kendiliğinden release edilip edilmeyeceği.",
    tabs: {
      general: "Genel",
      code: "Kod ve dokümanlar",
      pipeline: "Pipeline",
      deploy: "Deploy",
    ...
    reposTitle: "Repolar",
    reposDesc: "Her sub-repo'nun dokümanları ve pipeline'ı kendi sekmesinde. Adresleri Deploy sekmesinde, kapsam seçicisinden o sub-repo seçilince.",
    rootTab: "Kök",
  ...
  hosting: {
    title: "Deploy ve hosting",
    subtitle: "Bu kapsamın nereye deploy olduğu ve orada şu an ne durumda olduğu.",
    scope: "Kapsam",
    ...
    gcloud: {
      ...
      notBoundDesc:
        "Bu kapsamın deploy olduğu Cloud Run servisini veya GKE kümesini bağla; durumu, revizyonları ve trafiği burada görünsün.",
      bindResource: "Kaynak bağla",
      changeResource: "Kaynağı değiştir",
      unbind: "Bağlantıyı kaldır",
      unbindTitle: "Bu Google Cloud kaynağının bağlantısı kaldırılsın mı?",
      unbindDescription:
        "{name} Google Cloud tarafında olduğu gibi kalır. TaskTrooper yalnızca bu kapsam için onu okumayı bırakır.",
      unbound: "Google Cloud kaynağının bağlantısı kaldırıldı",
      loadFailed: "Google Cloud kaynağı yüklenemedi",
      resource: "Kaynak",
      kind: "Tür",
      project: "Proje",
      location: "Konum",
      cloudRunTitle: "Cloud Run servisi",
      serviceUrl: "Servis adresi",
      image: "Imaj",
      latestReady: "Son hazır revizyon",
      updatedAt: "Güncellendi",
      traffic: "Trafik dağılımı",
      stateUnknown: "Bilinmiyor",
      gkeTitle: "GKE kümesi",
      masterVersion: "Kontrol düzlemi sürümü",
      nodeCount: "Node sayısı",
      autopilot: "Autopilot",
      privateEndpoint: "Özel uç nokta",
      nodePools: "Node havuzları",
      detailUnavailableTitle: "Bağlantı kayıtlı; canlı okuma yapılamıyor",
      detailNotConnected:
        "Kayıtlı bir Google Cloud servis hesabı yok, bu yüzden kaynak okunamıyor. Bağlantının kendisi duruyor.",
      detailUnsupported:
        "Kayıtlı servis hesabının bu kaynağı okuma yetkisi yok. Bağlantının kendisi duruyor.",
    },
  },
